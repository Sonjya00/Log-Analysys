...
query_1 = ("select articles.title, count(*) as views from articles, log "
...
def print_query(query, query_msg):
...
print_query(query_1, query_1_msg)
print_query(query_2, query_2_msg)
